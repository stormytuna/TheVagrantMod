package thevagrantmod.character;
...
import static thevagrantmod.TheVagrantMod.makeID;
import static thevagrantmod.TheVagrantMod.characterPath;

public class TheVagrant extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("TheVagrant");
    ...
    public static class Meta {
        ...
        private static final Color cardColor = new Color(252f/255f, 174f/255f, 30f/255f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new TheVagrant(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public TheVagrant() {
        super(getNames()[0], Meta.THE_VAGRANT,
